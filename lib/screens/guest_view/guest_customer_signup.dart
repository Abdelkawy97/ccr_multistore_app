...
class GuestCustomerSignUpScreen extends StatefulWidget {
  const GuestCustomerSignUpScreen({Key? key}) : super(key: key);

  @override
  State<GuestCustomerSignUpScreen> createState() =>
      _GuestCustomerSignUpScreenState();
}

class _GuestCustomerSignUpScreenState extends State<GuestCustomerSignUpScreen> {
  // Firebase Instances
