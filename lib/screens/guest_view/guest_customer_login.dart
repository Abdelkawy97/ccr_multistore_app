...
class GuestCustomerLoginScreen extends StatefulWidget {
  const GuestCustomerLoginScreen({Key? key}) : super(key: key);

  @override
  State<GuestCustomerLoginScreen> createState() =>
      _GuestCustomerLoginScreenState();
}

class _GuestCustomerLoginScreenState extends State<GuestCustomerLoginScreen> {
  // Firebase Instances
